        ...
        IConfiguration configuration)
    {
        ...
        if (healthCheckOptions.Uri != null)
            services.AddHealthChecks()
                ...
                .AddMovieDbDataCheck("FxMoviesDB-PaidStreaming-Streamz-data", MovieEvent.FeedType.FreeVod, "streamzbasic")
                .AddMovieDbDataCheck("FxMoviesDB-PaidStreaming-StreamzPremium-data", MovieEvent.FeedType.FreeVod, "streamzplus")
